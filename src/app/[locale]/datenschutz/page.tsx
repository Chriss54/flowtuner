...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        title: locale === "de" ? "Datenschutzerklärung" : locale === "fr" ? "Politique de confidentialité" : "Privacy Policy",
        description: locale === "de"
            ? "Datenschutzerklärung und Informationen zum Datenschutz"
            : locale === "fr"
                ? "Politique de confidentialité et informations sur la protection des données"
...
export default async function DatenschutzPage({ params }: Props) {
    ...
    // Keep German content as this follows German/EU legal requirements
    return (
        <div className="article">
            <div className="container">
                <header className="article__header">
                    <h1>{locale === "de" ? "Datenschutzerklärung" : locale === "fr" ? "Politique de confidentialité" : "Privacy Policy"}</h1>
                </header>
